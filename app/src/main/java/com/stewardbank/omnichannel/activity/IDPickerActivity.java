...
public class IDPickerActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setSupportActionBar(getToolbar("Step 4:: Capture ID"));
    ...
    public void onClick(View view) {
        if(view.getId() == save.getId()){
            if(imageView.getVisibility() == View.VISIBLE){
                Intent intent = new Intent(this, ProofOfResidencePickerActivity.class);
                intent.putExtra("idNumber", idNumber);
                startActivity(intent);
                finish();
            }else{
                AppUtil.createShortNotification(this, "Please select ID image before proceeding");
            }
